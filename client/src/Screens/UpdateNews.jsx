...
const handleClick=async e=>{
    e.preventDefault()
    try {
        await axios.patch("https://reactapp-fnsv.onrender.com/news/updatenews/"+newsId,news)
...
useEffect(()=>{
    ...
    const fetchAllNews=async ()=>{
        ...
        console.log(newsId)   
      try { 
        const res=await axios.get("https://reactapp-fnsv.onrender.com/news/getnews/"+newsId)
        setNews(res.data);
        console.log(res)
    } catch (error) {
        console.log(error)
